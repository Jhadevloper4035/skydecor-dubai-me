...
export const shopLayout = [
  { href: "/products", name: "Default Grid" },
  { href: "/products", name: "Default List" },
  { href: "/products", name: "Full Width List" },
  { href: "/products", name: "Full Width Grid" },
  { href: "/products", name: "Left Sidebar" },
  { href: "/products", name: "Right Sidebar" },
  { href: "/products", name: "Filter Dropdown" },
  { href: "/products", name: "Filter Canvas" },
];

export const shopFeatures = [
  { href: "/products", name: "Categories Top 1" },
  { href: "/products", name: "Categories Top 2" },
  { href: "/shop-collection", name: "Shop Collection" },
  { href: "/products", name: "Breadcrumb IMG" },
  { href: "/products", name: "Breadcrumb Left" },
  { href: "/products", name: "Breadcrumb BG" },
  { href: "/products", name: "Load Button" },
  { href: "/products", name: "Pagination" },
  { href: "/products", name: "Infinite Scrolling" },
];

export const productStyles = [
  { href: "/products", name: "Product Style 1" },
  { href: "/products", name: "Product Style 2" },
  { href: "/products", name: "Product Style 3" },
  { href: "/products", name: "Product Style 4" },
  { href: "/products", name: "Product Style 5" },
  { href: "/products", name: "Product Style 6" },
  { href: "/products", name: "Product Style 7" },
];

export const otherShopMenus = [
  { href: "/products", name: "Wish List" },
  { href: "/products", name: "Search Result" },
  { href: "/products", name: "Shopping Cart" },
];

const shopLink = ({ category, subCategory, query } = {}) => {
...
export const blogLinks = [
  ...
  { href: "/blog-detail-02/1", name: "Blog Detail 2" },
];
...
export const productNavigation = {
  ...
  ranges: [
    {
      name: "PVC HPL",
      href: "/products/product-type/pvc-hpl",
      categoryLinks: [
        { name: "Abstract", href: "/products/product-type/pvc-hpl/category/abstract" },
        { name: "Solid", href: "/products/product-type/pvc-hpl/category/solid" },
        { name: "Stone", href: "/products/product-type/pvc-hpl/category/stone" },
        { name: "Woodgrain", href: "/products/product-type/pvc-hpl/category/woodgrain" },
      ],
    },
    {
      name: "Decorative HPL",
      href: "/products/product-type/decorative-hpl",
      categoryLinks: [
        {
          name: "Design Master",
    ...
    {
      name: "Acrylic HPL",
      href: "/products/product-type/acrylic-hpl",
      categoryLinks: [
        { name: "Abstract", href: "/products/product-type/acrylic-hpl/category/abstract" },
        { name: "Solid", href: "/products/product-type/acrylic-hpl/category/solid" },
        { name: "Stone", href: "/products/product-type/acrylic-hpl/category/stone" },
        { name: "Woodgrain", href: "/products/product-type/acrylic-hpl/category/woodgrain" },
      ],
    },
    {
      name: "Edgeband",
      href: "/products/product-type/edgeband",
      categoryLinks: [
        { name: "Abstract", href: "/products/product-type/edgeband/category/abstract" },
        { name: "Solid", href: "/products/product-type/edgeband/category/solid" },
        { name: "Stone", href: "/products/product-type/edgeband/category/stone" },
        { name: "Woodgrain", href: "/products/product-type/edgeband/category/woodgrain" },
      ],
    },
    {
      name: "MDF Boards",
      href: "/products/product-type/mdf-boards",
      categoryLinks: [
        { name: "Abstract", href: "/products/product-type/mdf-boards/category/abstract" },
        { name: "Solid", href: "/products/product-type/mdf-boards/category/solid" },
        { name: "Stone", href: "/products/product-type/mdf-boards/category/stone" },

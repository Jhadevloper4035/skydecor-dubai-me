...
const jobCrud = crudPath({
  tag: 'Jobs',
  collectionName: 'jobs',
  itemName: 'job',
  schemaName: 'Job',
  createSchema: 'JobCreate',
  updateSchema: 'JobUpdate',
  listParameters: [
    ...pageLimitParams,
    textQuery('department', 'sales'),
    enumQuery('employmentType', ['full-time', 'part-time', 'contract', 'internship']),
    boolQuery('isFeatured'),
    textQuery('search', 'designer'),
  ],
  adminItem: true,
});
...
const productEnquiryCrud = crudPath({
  ...
  listParameters: [
    ...
    textQuery('email', 'customer@example.me'),
...
const jobApplicationCrud = crudPath({
  tag: 'Job Applications',
  collectionName: 'applications',
  itemName: 'application',
  schemaName: 'JobApplication',
  createSchema: 'JobApplicationCreate',
  updateSchema: 'JobApplicationUpdate',
  listParameters: [
    ...pageLimitParams,
    enumQuery('status', ['new', 'reviewing', 'shortlisted', 'rejected', 'hired']),
    textQuery('jobSlug', 'sales-executive'),
    textQuery('email', 'candidate@example.me'),
    textQuery('search', 'candidate'),
  ],
  adminCreate: false,
  adminList: true,
  adminItem: true,
...
const productCrud = crudPath({
  ...
  listParameters: [
    ...
    textQuery('productType', 'decorative-hpl'),
    textQuery('category', 'design-master'),
...
const openApiDocument = {
  ...
  paths: {
    ...
    ...resourcePaths('jobs', jobCrud, {
      '/api/v1/{base}/slug/{slug}': withSlugLookup('Jobs', 'job', 'Job'),
    }),
    ...resourcePaths('job-applications', jobApplicationCrud),
    ...
    schemas: {
      ...
      AdminCreate: {
        ...
        properties: {
          ...
          email: { type: 'string', format: 'email', example: 'ops@skydecor.me' },
      ...
      Job: {
        ...
        properties: {
          _id: objectId,
          title: { type: 'string', example: 'Sales Executive' },
          slug: { type: 'string', example: 'sales-executive' },
          ...
          experienceLevel: { type: 'string', example: '2+ years' },
          summary: { type: 'string' },
          description: { type: 'string' },
      ...
      JobCreate: {
        type: 'object',
        required: ['title', 'slug', 'department', 'summary', 'description'],
        properties: {
          title: { type: 'string' },
          slug: { type: 'string' },
      ...
      JobUpdate: {
        allOf: [{ $ref: '#/components/schemas/JobCreate' }],
      },
      JobApplication: {
        type: 'object',
        properties: {
          _id: objectId,
          job: objectId,
          jobSlug: { type: 'string', example: 'sales-executive' },
          jobTitle: { type: 'string', example: 'Sales Executive' },
          fullName: { type: 'string', example: 'Candidate Name' },
      ...
      JobApplicationCreate: {
        type: 'object',
        required: ['jobSlug', 'fullName', 'email', 'phone'],
        properties: {
          jobSlug: { type: 'string', example: 'sales-executive' },
      ...
      Product: {
        ...
        properties: {
          ...
          productType: { type: 'string', example: 'decorative-hpl' },
          productTypeSlug: { type: 'string', example: 'decorative-hpl' },
          productName: { type: 'string', example: 'sdl-10102' },
          designName: { type: 'string', example: 'frosty white' },
          category: { type: 'string', example: 'design-master' },
          categorySlug: { type: 'string', example: 'design-master' },
      ...
      ProductEnquiryCreate: {
        type: 'object',
        required: ['productCode', 'name', 'email', 'phone'],
        properties: {
          productCode: { type: 'string', example: 'sdl-10102-fsr' },
          name: { type: 'string' },
          email: { type: 'string', format: 'email' },
